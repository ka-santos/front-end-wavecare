        ...
        <div className="flex flex-col justify-between gap-5 md:flex-row">
          <div>
            ...
            <p className="GolosText mt-1 text-lg">
              Encante-se com os itens de papelaria mais amados da Papel & Ponto.
            </p>
          </div>

          <button className="btn GolosText cursor-pointer rounded-md bg-black px-6 py-3 text-white transition-all duration-300"> Ver tudo
                    ...
                    <span className='absolute left-3 top-3 rounded-full bg-white px-4 py-1 font-mono'>
                      ...
                      <div className='absolute right-5 top-5 flex flex-col gap-2'>
                        <i
                          ...
                          className='bi bi-balloon-heart product-icon flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-black/40 text-white'
                        ></i>

                        <i
                          onClick={() => addCart(item)}
                          className='bi bi-cart3 product-icon flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-black/40 text-white'
                        ></i>
                      </div>
